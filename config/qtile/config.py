...
keys = [
    ...
    # color inversion
    Key([mod], "i",
        lazy.spawn("/home/arch/.config/settings/color_inversion"),
    ),

    # pactl volume control
    Key([mod, "shift"], "x",
        lazy.spawn("/home/arch/.config/settings/inc_vol"),
    ),
    Key([mod, "shift"], "z",
        lazy.spawn("/home/arch/.config/settings/dec_vol"),
    ),
